...
namespace BulkyBookII.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetOrderList(string status)
        {
            ...
            // if the role is admin employee they can see all orders  
            ...
            switch (status)
            {
                ...
                case "completed":
                    ...
                    break;
                case "rejected":
                    orderHeaderList = orderHeaderList.Where(o => o.OrderStatus == SD.StatusCancelled || o.OrderStatus == SD.StatusRefunded || o.PaymentStatus == SD.PaymentStatusRejected);
                    break;
                default:
                    break;
