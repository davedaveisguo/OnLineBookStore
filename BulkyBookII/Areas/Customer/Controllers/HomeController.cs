    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(ShoppingCart cartObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cartFromDb == null)
                {
                    // no record exist for this product and this user we need to add it
                    _unitOfWork.ShoppingCart.Add(cartObject);
                }
                else
                {
                    // we have this cart we update the count  update cartFromDb therefore id wont be 0
