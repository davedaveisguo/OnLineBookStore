...
using BulkyBookII.Models.ViewModels;
...
namespace BulkyBookII.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                ...
                var cnt = HttpContext.Session.GetInt32(SD.ssShoppingCart);
                _unitOfWork.ShoppingCart.Remove(cart);
                _unitOfWork.Save();
                HttpContext.Session.SetInt32(SD.ssShoppingCart, (int)cnt - 1);
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            if (stripeToken == null)
            {
                // company user make payment later on
